		...
		<?php if ($overal_score !='0') :?>
			<div class="review-top">								
				<div class="overall-score">
					...
					<div class="overall-user-votes"><span><?php $user_rates = get_post_meta(get_the_ID(), 'post_user_raitings', true); echo ''.$user_rates['criteria'][0]['count'] ;?></span> <?php esc_html_e('reviews', 'rehub-theme'); ?></div>
					<?php endif;?>				
				</div>				
